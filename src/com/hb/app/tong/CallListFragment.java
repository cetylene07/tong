...
public class CallListFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		list = this.makeCallInfo();
		Log.i("TONG", "makeCallInfo Complete");
	}
		...
		spin.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> parent, View view,
				...
				case 0:
					...
					MyList = (ListView) getView().findViewById(R.id.call_list);
				...
				case 2:
					...
					adapterView = new MyListAdapter(getActivity(),
							R.layout.incall_view, temp_list, "average_indur");
				...
				case 3:
					...
					// 占쏙옙 占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙 占쏙옙占�占쌘듸옙占쌔억옙
					// 占싫댐옙.
					if (list.get(list.size() - 1).out_count != list.get(list
							.size() - 1).out_count) {
				...
				case 5:
					...
					// 커占쏙옙占쏙옙 占썰를 占싱울옙占싹울옙 占쏙옙占쏙옙트占썰에 占쏙옙占�
					adapterView = new MyListAdapter(getActivity(),
							R.layout.incall_view, temp_list, "average_outdur");
				...
				case 6:
					...
					// 占쏙옙 占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙 占쏙옙占�占쌘듸옙占쌔억옙
					// 占싫댐옙.
					if (list.get(list.size() - 1).miss_count != list.get(list
							.size() - 1).miss_count) {
